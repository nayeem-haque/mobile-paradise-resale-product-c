...
const AddProduct = () => {
  ...
  const handleProduct = (event) => {
    ...
    fetch(" https://mobile-paradise-server.vercel.app/product", {
      method: "POST",
      headers: {
        ...
        <form onSubmit={handleProduct}>
          <div className="w-full py-2 text-xl font-normal text-gray-700 bg-white bg-clip-padding">
            <div className="mb-6">
              ...
              <select id="id">
                <option value="6384c5f43a47bd26873697fd" selected>
                  Infinix
                </option>
                <option value="6384c6273a47bd268736b635">Huawei</option>
                <option value="6384c65e3a47bd268736d823">Oppo</option>
              </select>
            </div>
          </div>
